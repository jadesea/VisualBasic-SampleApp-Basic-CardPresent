...
#Region "Transaction Processing"
        ...
        Private Sub cmdAuthorizeAndCapture_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdAuthorizeAndCapture.Click
            ...
            If _bcs IsNot Nothing Then
                ...
                Try
                    ...
                    processResponse(Helper.ProcessBCPTransaction(TransactionType.AuthorizeAndCapture, BCtransaction, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                Catch ex As Exception
                    MessageBox.Show(ex.Message)
                Finally
                    Cursor = Cursors.Default
        ...
        Private Sub cmdAuthorize_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdAuthorize.Click
            ...
            If _bcs IsNot Nothing Then 'Process a BankCard Transaction
                Try
                    ...
                    processResponse(Helper.ProcessBCPTransaction(TransactionType.Authorize, BCtransaction, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                Catch ex As Exception
                    MessageBox.Show(ex.Message)
                Finally
                    Cursor = Cursors.Default
                ...
                If _bcs IsNot Nothing Then 'Process a BankCard Transaction
                    Try
                        ...
                        If ChkMultiplePartialCapture.Checked Then
                            ...
                            processResponse(Helper.ProcessBCPTransaction(TransactionType.Capture, Nothing, BCDifferenceData, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                            processResponse(Helper.ProcessBCPTransaction(TransactionType.Capture, Nothing, BCDifferenceData, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                        Else
        ...
        Private Sub cmdCaptureAll_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdCaptureAll.Click
            ...
            If _bcs IsNot Nothing Then 'Process a BankCard Transaction
                Try
                    ...
                    Else
                        If chkCaptureAllAndSelectiveAsync.Checked Then
                            processResponse(Helper.ProcessBCPTransaction(TransactionType.CaptureAllAsync, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, captures, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                        Else
                            processResponse(Helper.ProcessBCPTransaction(TransactionType.CaptureAll, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, captures, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                        End If
                    End If
                Catch ex As Exception
                    MessageBox.Show(ex.Message)
        ...
        Private Sub cmdCaptureSelective_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdCaptureSelective.Click
            ...
            If _bcs IsNot Nothing Then 'Process a BankCard Transaction
                Try
                    ...
                    If chkCaptureAllAndSelectiveAsync.Checked Then
                        processResponse(Helper.ProcessBCPTransaction(TransactionType.CaptureSelectiveAsync, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, transactionIDs, captures, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                    Else
                        processResponse(Helper.ProcessBCPTransaction(TransactionType.CaptureSelective, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, transactionIDs, captures, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                    End If
                ...
                Try
                    ...
                    If _bcs.Tenders.CreditAuthorizeSupport = CreditAuthorizeSupportType.AuthorizeOnly Then
                        ...
                        For Each _RD As ResponseDetails In txnsToProcess
                            ...
                            processResponse(Helper.ProcessBCPTransaction(TransactionType.ReturnById, Nothing, Nothing, Nothing, BCRDifferenceData, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                        Next _RD
                    Else
            ...
            ElseIf _svas IsNot Nothing Then 'Process a Stored Value Transaction
                ...
                Try
                    ...
                    If _svas.Tenders.CreditAuthorizeSupport = CreditAuthorizeSupportType.AuthorizeAndCaptureOnly Then
                        ...
                        response = Helper.ProcessBCPTransaction(TransactionType.CaptureAll, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked)
                        If response.Count < 1 Then
                            Return
                        End If
                        ChkLstTransactionsProcessed.Items.Add(response(0))
        ...
        Private Sub cmdReturn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdReturnUnlinked.Click
            ...
            If _bcs IsNot Nothing Then 'Process a BankCard Transaction
                Try
                    Dim BCtransaction As BankcardTransaction = dg.SetBankCardTxnData()
                    processResponse(Helper.ProcessBCPTransaction(TransactionType.Return, BCtransaction, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                Catch ex As Exception
                    MessageBox.Show(ex.Message)
                Finally
                    Cursor = Cursors.Default
            ...
            If _bcs IsNot Nothing Then 'Process a BankCard Transaction
                Try
                    ...
                    For Each _RD As ResponseDetails In txnsToProcess
                        ...
                        processResponse(Helper.ProcessBCPTransaction(TransactionType.Adjust, Nothing, Nothing, Nothing, Nothing, aTransaction, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                    Next _RD
                Catch ex As Exception
                    MessageBox.Show(ex.Message)
                Finally
            ...
            If _bcs IsNot Nothing Then 'Process a BankCard Transaction
                Try
                    ...
                    For Each _RD As ResponseDetails In txnsToProcess
                        ...
                        processResponse(Helper.ProcessBCPTransaction(TransactionType.Undo, Nothing, Nothing, Nothing, Nothing, Nothing, uTransaction, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                    Next _RD
                Catch ex As Exception
                    MessageBox.Show(ex.Message)
                Finally
        ...
        Private Sub cmdVerify_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdVerify.Click
            ...
            If _bcs IsNot Nothing Then 'Process a BankCard Transaction
                Try
                    ...
                    processResponse(Helper.ProcessBCPTransaction(TransactionType.Verify, BCtransaction, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked))
                Catch ex As Exception
                    MessageBox.Show(ex.Message)
                Finally
                    Cursor = Cursors.Default
        ...
        Private Sub CmdRequestTransaction_Click(ByVal sender As Object, ByVal e As EventArgs) Handles CmdRequestTransaction.Click
            ...
            If _bcs IsNot Nothing Then 'Process a BankCard Transaction
                Try
                    ...
                    Helper.ProcessBCPTransaction(TransactionType.Authorize, BCtransaction, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked)
                Catch ex As Exception
                    MessageBox.Show(ex.Message)
                Finally
                    Cursor = Cursors.Default
...
#Region "Additional Operations"
        ...
        Private Sub cmdCardTokenization_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdCardTokenization.Click
            ...
            If _bcs IsNot Nothing Then 'Process a BankCard Transaction
                Try
                    ...
                    Dim BCtransaction As BankcardTransaction = dg.SetBankCardTxnData()
                    response = Helper.ProcessBCPTransaction(TransactionType.Authorize, BCtransaction, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked)
                    If response.Count < 1 Then
                        Return
                    End If
                    ChkLstTransactionsProcessed.Items.Add(response(0))
            ...
            If _bcs IsNot Nothing Then 'Process a BankCard Transaction
                ...
                Try
                    ...
                    If chkL2AuthAndCapture.Checked AndAlso _bcs.Tenders.CreditAuthorizeSupport = CreditAuthorizeSupportType.AuthorizeOnly Then
                        ...
                        response = Helper.ProcessBCPTransaction(TransactionType.AuthorizeAndCapture, BCtransaction, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked)
                        If response.Count < 1 Then
                            Return
                        End If
                        ChkLstTransactionsProcessed.Items.Add(response(0))
                    ElseIf Not chkL2AuthAndCapture.Checked Then
                        ...
                        If BCR.CommercialCardResponse = CommercialCardResponse.BusinessCard Or BCR.CommercialCardResponse = CommercialCardResponse.CorporateCard Or BCR.CommercialCardResponse = CommercialCardResponse.PurchaseCard Then
                            ...
                            response = Helper.ProcessBCPTransaction(TransactionType.Capture, Nothing, BCP, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, ChkAcknowledge.Checked, ChkForceCloseBatch.Checked)
                            If response.Count < 1 Then
                                Return
                            End If
                            ChkLstTransactionsProcessed.Items.Add(response(0))
        ...
        Private Sub viewTransactionsToolStripMenuItem_Click(ByVal sender As Object, ByVal e As EventArgs) Handles menuStrip1.Click
